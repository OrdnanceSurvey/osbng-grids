...
The repository also contains the Python [script](osbng-grids/scripts/create_osbng_grids.py) used for data generation and a Jupyter notebook demonstrating custom grid creation with the [`osbng`](https://github.com/OrdnanceSurvey/osbng-py) Python package.
